...
(function() {
        ...
        if (h && p && D) {
            ...
            if (!u)
                try {
                    ...
                    p = window.open(),
                    p.document.write("<img src='" + h + "'></img><div>Please right click on the image and save it to your device</div>"),
                    p.document.close()
                }
        }
    }
    ...
    function hb(h) {
        if (!ib) {
            ...
            h.creditText = ja("B`ow`rKR/bnl")) : (p = h.updateOption("creditText"),
            D = h.updateOption("creditHref"));
            if (h.creditHref && h.creditText) {
                ...
                h._creditLink.setAttribute("style", "display:none;outline:none;margin:0px;position:absolute;right:2px;top:" + (h.height - 14) + "px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),
    ...
    function ua(h, p, D) {
        p.getAttribute("state") || (p.style.backgroundColor = h.toolbar.backgroundColor,
        p.style.color = h.toolbar.fontColor,
        p.style.border = "none",
        sa(h, p, {
        ...
        p.setAttribute("title", h._cultureInfo[D + "Text"]),
        p.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + jb[D].image + "' alt='" + h._cultureInfo[D + "Text"] + "' />")
    }
    function Qa() {
    ...
    function V(h, p, D, r, v) {
        ...
        h = {};
        this.theme && u(p) && u(r) ? h = u(ya[this.theme]) ? ya.light1 : ya[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[p]) && (null === r ? h = this.parent.themeOptions[p] : 0 < this.parent.themeOptions[p].length && (r = Math.min(this.parent.themeOptions[p].length - 1, r),
        h = this.parent.themeOptions[p][r]));
        this.themeOptions = h;
        this.options = D ? D : {
            _isPlaceholder: !0
        };
    ...
    (function() {
        U.fSDec = function(h) {
            for (var p = "", r = 0; r < h.length; r++)
                p += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r));
            return p
        }
        ;
        U.obj = {
    ...
    var $a = {}
      ...
      , ba = function(h, p, r) {
        ...
        O && (p = Math.floor(h),
        z = -Math.floor(Math.log(h) / Math.LN10 + 1),
        U = 0 === h ? 0 : 0 === p ? -(I + z) : String(p).length - I,
        F /= Math.pow(10, U));
        0 > E && (E = Q);
        F = (h * F).toFixed(N);
        p = F.split(".");
        ...
        for (O = z = Q = N = E = 0; 0 < L.length; )
            ...
            "#" === p || "0" === p)
                ...
                r += p.replace(/[0]+/, function(h) {
                    return $(U, h.length)
                }));
        H = "";
        for (L = !1; 0 < R.length; )
            p = R.shift(),
            "#" === p || "0" === p ? 0 < h.length && 0 !== Number(h.join("")) ? (H += h.shift(),
            L = !0) : "0" === p && (H += "0",
      ...
      , Ra = function(h) {
        var p = 0
          , r = 0;
        h = h || window.event;
        h.offsetX || 0 === h.offsetX ? (p = h.offsetX,
        r = h.offsetY) : h.layerX || 0 == h.layerX ? (p = h.layerX,
        r = h.layerY) : (p = h.pageX - h.target.offsetLeft,
      ...
      , ea = function(h, p, r, u, v, H, F, z, E, L, R, N, O) {
        ...
        h.strokeStyle = z,
        h.moveTo(p, r),
        h.rect(p - O, r - O, u - p + 2 * O, v - r + 2 * O),
        h.stroke());
        h.restore();
        !0 === E && (h.save(),
        h.beginPath(),
        ...
        h.lineTo(u, r),
        h.closePath(),
        F = h.createLinearGradient((u + p) / 2, r + I, (u + p) / 2, r),
        F.addColorStop(0, H),
        ...
        h.lineTo(u, v),
        h.closePath(),
        F = h.createLinearGradient((u + p) / 2, v - I, (u + p) / 2, v),
        F.addColorStop(0, H),
        F.addColorStop(1, "rgba(255, 255, 255, .4)"),
        h.fillStyle = F,
        h.fill(),
        ...
        h.lineTo(p, v),
        h.closePath(),
        F = h.createLinearGradient(p + I, (v + r) / 2, p, (v + r) / 2),
        F.addColorStop(0, H),
        ...
        h.lineTo(u - I, v - I),
        h.lineTo(u, v),
        F = h.createLinearGradient(u - I, (v + r) / 2, u, (v + r) / 2),
        F.addColorStop(0, H),
        F.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        h.fillStyle = F,
        F.addColorStop(0, H),
    ...
    V.prototype.setOptions = function(h, p) {
        if (ra[this._defaultsKey]) {
            ...
            for (u in r)
                "publicProperties" !== u && r.hasOwnProperty(u) && (this[u] = h && u in h ? h[u] : p && u in p ? p[u] : r[u])
        } else
    ...
    V.prototype.addTo = function(h, p, r, u) {
        ...
        h.splice(r, 0, p),
        u && (this.chart || this).render()) : window.console && (v.publicProperties && v.publicProperties.hasOwnProperty(h) && "readOnly" === v.publicProperties[h] ? window.console.log('Property "' + h + '" is read-only.') : window.console.log('Property "' + h + "\" doesn't exist. Please check for typo."))
    }
    ;
        ...
        if (0 === this.frontSize)
            ...
            for (; 0 < h.length; ) {
                ...
                var z = v
                  ...
                  , u = u + F.height
                  , h = Ia(h.slice(F.text.length, h.length));
                H && u > H && (F = p.pop(),
                u -= F.height,
                v = z)
            }
    ...
    Aa.prototype.setLayout = function() {
        if (this.text) {
            ...
            I = "right",
            this.width = L.height,
            this.height = L.width) : "center" === this.horizontalAlign && (v = h.y1 + (h.height / 2 - L.height / 2),
            r = h.x1 + (h.width / 2 - L.width / 2),
            I = "center",
            this.width = L.width,
    ...
    var Na = {
        ...
        formatNumber: function(h, p, r) {
            r = r || "en";
            if (Ma[r])
                return ba(h, p || "#,##0.##", new La(r));
            throw "Unknown Culture Name";
        },
        formatDate: function(h, p, r) {
            r = r || "en";
            if (Ma[r])
                return Ca(h, p || "DD MMM YYYY", new La(r));
            throw "Unknown Culture Name";
        }
    };
    ...
    Na.Chart = function() {
        ...
        function E(a, d, b, c, e, g, k, l, w, m) {
            ...
            a.beginPath();
            w && 0 < l.thickness ? (a.moveTo(c - k.thickness / 2, Math.round((b + e) / 2) - q),
            a.lineTo(d + k.thickness / 2, Math.round((b + e) / 2) - q)) : 0 < l.thickness && (a.moveTo(Math.round((d + c) / 2) - q, b + k.thickness / 2),
            a.lineTo(Math.round((d + c) / 2) - q, e - k.thickness / 2));
            a.stroke();
            a.strokeStyle = k.color || g;
            a.lineWidth = k.thickness || 2;
            a.setLineDash && a.setLineDash(R(k.dashType, k.thickness));
            a.beginPath();
            w && 0 < k.thickness ? (a.moveTo(c - s, b),
            a.lineTo(c - s, e),
            a.moveTo(d + s, b),
            a.lineTo(d + s, e)) : 0 < k.thickness && (a.moveTo(d, b + s),
            a.lineTo(c, b + s),
            a.moveTo(d, e - s),
            a.lineTo(c, e - s));
            a.stroke();
        ...
        p.prototype.categoriseDataSeries = function() {
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                ...
                k = a = 0; k < b.plotUnits.length; k++)
                    b.plotUnits[k].previousDataSeriesCount = a,
                    a += b.plotUnits[k].dataSeriesIndexes.length
        }
        ;
                ...
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, k = [], l = [], w = Infinity, m = -Infinity, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    for (n = 0; n < q.dataPoints.length; n++) {
                        ...
                        if (c < p && !f)
                            ...
                            c < b.viewPortMin && (b.viewPortMin = c);
                            c > b.viewPortMax && (b.viewPortMax = c);
                            null === q.dataPoints[n].y ? b.viewPortMin === c && h < c && (b.viewPortMin = h) : (a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + e,
                            0 <= e ? k[c] ? k[c] += e : (k[c] = e,
                            w = Math.min(e, w)) : l[c] ? l[c] += e : (l[c] = e,
                            m = Math.max(e, m)))
                        }
                    }
                    a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, k),
                    d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, l)) : (d.dataPointYPositiveSums = k,
                    d.dataPointYNegativeSums = l));
                    q.axisX.valueType = q.xValueType = g ? "dateTime" : "number"
                }
                for (n in k)
                    k.hasOwnProperty(n) && !isNaN(n) && (a = k[n],
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, k = !1, l = !1, w = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if ("normal" === s.axisPlacement || "xySwapped" === s.axisPlacement)
                        var h = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity
                ...
                d.min = u(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : k && !l ? (d.max = u(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
                d.min = u(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : k && l ? (d.max = u(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
                d.min = u(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !k && l && (d.max = u(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1),
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g, k, l = !1, w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    for (s = 0; s < m.dataPoints.length; s++) {
                        ...
                        m.dataPoints[s].x.getTime ? (l = !0,
                        c = m.dataPoints[s].x.getTime()) : c = m.dataPoints[s].x;
                        ...
                        g < d.min && (d.min = g);
                        k > d.max && (d.max = k);
                        0 < s && (a.axisX.logarithmic ? (B = c / m.dataPoints[s - 1].x,
                        1 > B && (B = 1 / B),
                        b.minDiff > B && 1 !== B && (b.minDiff = B)) : (B = c - m.dataPoints[s - 1].x,
                        0 > B && (B *= -1),
                        b.minDiff > B && 0 !== B && (b.minDiff = B)),
                        e && (null !== e[0] && m.dataPoints[s - 1].y && null !== m.dataPoints[s - 1].y[0]) && (a.axisY.logarithmic ? (B = e[0] / m.dataPoints[s - 1].y[0],
                        1 > B && (B = 1 / B),
                        d.minDiff > B && 1 !== B && (d.minDiff = B)) : (B = e[0] - m.dataPoints[s - 1].y[0],
                        0 > B && (B *= -1),
                        d.minDiff > B && 0 !== B && (d.minDiff = B))));
                        if (!(c < r) || q) {
                            if (!q && (q = !0,
                            ...
                            k > d.viewPortMax && (d.viewPortMax = k))
                        }
                    }
        ...
        p.prototype.calculateAutoBreaks = function() {
                    ...
                    if (c || b)
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, m = f.min, l = f.max, k = d.min, n = d.max, f = f._dataRanges, d = d._dataRanges, q, w = 0, s = 0; s < a.dataSeriesIndexes.length; s++) {
                            ...
                            if (!(4 > h.dataPoints.length))
                                for (w = 0; w < h.dataPoints.length; w++)
                                    if (c && (q = (l + 1 - m) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100,
                                    g = h.dataPoints[w].x.getTime ? h.dataPoints[w].x.getTime() : h.dataPoints[w].x,
                                    q = Math.floor((g - m) / q),
                                    g < f[q].min && (f[q].min = g),
                                    g > f[q].max && (f[q].max = g)),
                                    b) {
                    ...
                    for (var c = a.axisX.dataInfo, b = c.min, d = c.max, f = c._dataRanges, g, m = 0, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        ...
                        if (!(4 > k.dataPoints.length))
                            for (m = 0; m < k.dataPoints.length; m++)
                                ...
                                c = k.dataPoints[m].x.getTime ? k.dataPoints[m].x.getTime() : k.dataPoints[m].x,
                                g = Math.floor((c - b) / g),
                                c < f[g].min && (f[g].min = c),
                                c > f[g].max && (f[g].max = c)
                    }
            ...
            for (var c, e = this, g = !1, k = 0; k < this._axes.length; k++)
                if (this._axes[k].scaleBreaks && this._axes[k].scaleBreaks.autoCalculate && 1 <= this._axes[k].scaleBreaks.maxNumberOfAutoBreaks) {
                    ...
                    for (var l = 0; l < 100 / Math.max(parseFloat(this._axes[k].scaleBreaks.collapsibleThreshold) || 10, 10); l++)
                        this._axes[k].dataInfo._dataRanges.push({
                            min: Infinity,
                            max: -Infinity
                        })
                }
            if (g) {
                for (k = 0; k < this.plotInfo.plotTypes.length; k++)
                    for (g = this.plotInfo.plotTypes[k],
                ...
                for (k = 0; k < this._axes.length; k++)
                    if (this._axes[k].dataInfo._dataRanges) {
                        ...
                        for (l = 0; l < Math.min(g.length, this._axes[k].scaleBreaks.maxNumberOfAutoBreaks); l++)
                            c = a(g[l].start, g[l].end, this._axes[k].logarithmic ? this._axes[k].dataInfo.max / this._axes[k].dataInfo.min : this._axes[k].dataInfo.max - this._axes[k].dataInfo.min, this._axes[k].logarithmic),
                            this._axes[k].scaleBreaks.autoBreaks.push(new L(this,"autoBreaks",c,l,++this._eventManager.lastObjectId,this._axes[k].scaleBreaks)),
                            this._axes[k].scaleBreaks._appliedBreaks.push(this._axes[k].scaleBreaks.autoBreaks[this._axes[k].scaleBreaks.autoBreaks.length - 1]);
                ...
                if (!(b && 1 < b.length)) {
                    ...
                    if (this._lastTouchData.scroll && this.zoomEnabled)
                        ...
                        for (b = 0; b < d.length; b++)
                            ...
                            k.initMouseEvent(e, !0, !0, window, 1, c.screenX, c.screenY, c.clientX, c.clientY, !1, !1, !1, !1, 0, null),
                            c.target.dispatchEvent(k),
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    if (this.panEnabled)
                        for (e = g = 0; e < this._axes.length; e++)
                            ...
                            k = !0) : b.viewportMaximum > b.maximum && (g = b.viewportMaximum / b.maximum,
                            b.sessionVariables.newViewportMinimum = b.viewportMinimum / g,
                            b.sessionVariables.newViewportMaximum = b.viewportMaximum / g,
                            k = !0) : b.viewportMinimum < b.minimum ? (g = b.minimum - b.viewportMinimum,
                            b.sessionVariables.newViewportMinimum = b.viewportMinimum + g,
                            b.sessionVariables.newViewportMaximum = b.viewportMaximum + g,
                            k = !0) : b.viewportMaximum > b.maximum && (g = b.viewportMaximum - b.maximum,
                            b.sessionVariables.newViewportMinimum = b.viewportMinimum - g,
                    ...
                    k && (this._ignoreNextEvent = !0,
                    this._dispatchRangeEvent("rangeChanging", "zoom"),
                    this.render(),
                    this._dispatchRangeEvent("rangeChanged", "zoom"),
                    k && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (Qa(this._zoomButton, this._resetButton),
                    ua(this, this._zoomButton, "pan"),
                    ua(this, this._resetButton, "reset")))
                }
            }
            ...
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if ((!e || 2 < Math.abs(b) || !g || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled))
                    if (this.panEnabled)
                        ...
                        clearTimeout(k._panTimerId),
                        k._panTimerId = setTimeout(function(c, b, e, f) {
                            return function() {
                                k._zoomPanToSelectedRegion(c, b, e, f, !0) && (k._dispatchRangeEvent("rangeChanging", "pan"),
                                k.render(),
                                k._dispatchRangeEvent("rangeChanged", "pan"),
                                k.dragStartPoint.x = a,
                                k.dragStartPoint.y = d)
                            }
        ...
        p.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var k = na("indexLabelFontWeight", m.dataPoint, m.dataSeries)
                  ...
                  , p = u(m.dataPoint.indexLabelLineThickness) ? u(m.dataSeries.options.indexLabelLineThickness) ? 0 : m.dataSeries.options.indexLabelLineThickness : m.dataPoint.indexLabelLineThickness
                ...
                if (null !== x && "" !== x) {
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== t ? (e = b.y1,
                        g = b.y2,
                        0 < ma ? (n = m.point.y - w - k - c,
                        n < e && (n = "auto" === t ? Math.max(m.point.y, e) + k + c : e + k + c,
                        v = n + w > m.point.y)) : (n = m.point.y + k + c,
                        n > g - w - k - c && (n = "auto" === t ? Math.min(m.point.y, g) - w - k - c : g - w - k - c,
                        v = n < m.point.y))) : (e = Math.max(m.bounds.y1, b.y1),
                        g = Math.min(m.bounds.y2, b.y2),
                        c = 0 <= s.indexOf("range") || "error" === s ? 0 < ma ? Math.max(m.bounds.y1, b.y1) + w / 2 + k : Math.min(m.bounds.y2, b.y2) - w / 2 - k : (Math.max(m.bounds.y1, b.y1) + Math.min(m.bounds.y2, b.y2)) / 2,
                        0 < ma ? (n = Math.max(m.point.y, c) - w / 2,
                        n < e && ("bubble" === s || "scatter" === s) && (n = Math.max(m.point.y - w - k, b.y1 + k))) : (n = Math.min(m.point.y, c) - w / 2,
                        n > g - w - k && ("bubble" === s || "scatter" === s) && (n = Math.min(m.point.y + k, b.y2 - w - k))),
                        n = Math.min(n, g - w))
                    } else
                        ...
                        "inside" !== t ? (k = b.x1,
                        g = b.x2,
                        0 > ma ? (q = m.point.x - l - e - c,
                        q < k && (q = "auto" === t ? Math.max(m.point.x, k) + e + c : k + e + c,
                        v = q + l > m.point.x)) : (q = m.point.x + e + c,
                        q > g - l - e - c && (q = "auto" === t ? Math.min(m.point.x, g) - l - e - c : g - l - e - c,
                        v = q < m.point.x))) : (k = Math.max(m.bounds.x1, b.x1),
                        Math.min(m.bounds.x2, b.x2),
                        c = 0 <= s.indexOf("range") || "error" === s ? 0 > ma ? Math.max(m.bounds.x1, b.x1) + l / 2 + e : Math.min(m.bounds.x2, b.x2) - l / 2 - e : (Math.max(m.bounds.x1, b.x1) + Math.min(m.bounds.x2, b.x2)) / 2,
                        q = 0 > ma ? Math.max(m.point.x, c) - l / 2 : Math.min(m.point.x, c) - l / 2,
                        q = Math.max(q, k));
                    "vertical" === C && (n += w);
                    f.x = q;
                    f.y = n;
                    f.render(!0);
                    p && ("inside" !== t && (0 > s.indexOf("bar") && ("error" !== s || !m.axisSwapped) && m.point.x > b.x1 && m.point.x < b.x2 || !v) && (0 > s.indexOf("column") && ("error" !== s || m.axisSwapped) && m.point.y > b.y1 && m.point.y < b.y2 || !v)) && (d.lineWidth = p,
                    d.strokeStyle = h ? h : "gray",
                    d.setLineDash && d.setLineDash(R(B, p)),
                    d.beginPath(),
                    d.moveTo(m.point.x, m.point.y),
                    0 <= s.indexOf("bar") || "error" === s && m.axisSwapped ? d.lineTo(q + (0 < m.direction ? 0 : l), n + ("horizontal" === C ? w : -w) / 2) : 0 <= s.indexOf("column") || "error" === s && !m.axisSwapped ? d.lineTo(q + l / 2, n + ((0 < m.direction ? w : -w) + ("horizontal" === C ? w : -w)) / 2) : d.lineTo(q + l / 2, n + ((n < m.point.y ? w : -w) + ("horizontal" === C ? w : -w)) / 2),
                    d.stroke())
                }
            }
            d = {
            ...
            for (a = 0; a < this._indexLabels.length; a++)
                ...
                f = na("indexLabelBackgroundColor", m.dataPoint, m.dataSeries),
                m.dataSeries.indexLabelBackgroundColor = u(f) ? r ? "transparent" : null : f;
            return d
        }
        ;
                ...
                for (var g = [], k, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < s.length) {
                        for (var u = !1, t = 0; t < s.length; t++)
                            ...
                            !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !u)))
                                if ("number" !== typeof s[t].y)
                                    ...
                                    p || u ? (!p && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType || q === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (b.stroke(),
                                    b.beginPath(),
                                    b.moveTo(k.x, k.y),
                                    ...
                                    t < s.length - 1 && (h !== (s[t].lineColor || B) || q !== (s[t].lineDashType || m.lineDashType)) && (b.stroke(),
                                    b.beginPath(),
                                    b.moveTo(C, x),
                                    h = s[t].lineColor || B,
                                    b.strokeStyle = h,
                                    b.setLineDash && (s[t].lineDashType ? (q = s[t].lineDashType,
                                    b.setLineDash(R(q, m.lineThickness))) : (q = m.lineDashType,
                                    b.setLineDash(f))));
                        ...
                        for (var u = !1, t = 0; t < s.length; t++)
                            ...
                            !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !u)))
                                if ("number" !== typeof s[t].y)
                                    ...
                                    b.setLineDash(f))));
                                    if (0 < s[t].markerSize || 0 < m.markerSize)
                                        y = m.getMarkerProperties(t, C, x, b),
                                        g.push(y),
                                        A = N(A),
                                        r && g.push({
                                            x: C,
                ...
                for (var k = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < s.length)
                        ...
                        p = 0; p < s.length; p++)
                            ...
                            !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !u)))
                                if ("number" !== typeof s[p].y)
                                    0 < p && !u && (m.connectNullData ? c.setLineDash && (0 < x.length && (m.options.nullDataLineDashType || !s[p - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = n,
                                    q = m.nullDataLineDashType) : (d(x),
                                    x = [])),
                                    u = !0;
                                else {
                                    ...
                                    p < s.length - 1 && (h !== (s[p].lineColor || B) || q !== (s[p].lineDashType || m.lineDashType)) && (h = s[p].lineColor || B,
                                    x[x.length - 1].newStrokeStyle = h,
                                    c.setLineDash && (s[p].lineDashType ? (q = s[p].lineDashType,
                                    x[x.length - 1].newLineDashArray = R(q, m.lineThickness)) : (q = m.lineDashType,
                ...
                for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    if (0 < t.length) {
                        ...
                        for (m = 0; m < t.length; m++)
                            if (c = t[m].x.getTime ? t[m].x.getTime() : t[m].x,
                            !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[m].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[m].y)
                                    ...
                                    q = "undefined" !== typeof k[c] ? k[c] : n,
                                    k[c] = y;
                                else if (q = a.axisY.convertValueToPixel(t[m].y),
                                0 <= t[m].y) {
                        ...
                        for (m = 0; m < t.length; m++)
                            ...
                            !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[m].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[m].y)
                                    ...
                                    w[c] = t[m].y + (w[c] ? w[c] : 0),
                                    s = k[c] ? k[c] : n,
                                    k[c] = y = a.axisY.convertValueToPixel(w[c]);
                                else if (s = a.axisY.convertValueToPixel(t[m].y),
                                0 <= t[m].y) {
                                    var A = g[c] ? g[c] : 0;
                                    y = n + A;
                                    s += A;
                        ...
                        for (m = 0; m < t.length; m++)
                            ...
                            !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[m].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[m].y) {
                                    ...
                                    w[c] = x + (w[c] ? w[c] : 0),
                                    s = k[c] ? k[c] : n,
                                    k[c] = x = a.axisY.convertValueToPixel(w[c]);
        ...
        p.prototype.renderArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                g.clip();
                r && (k.beginPath(),
                k.rect(s.x1, s.y1, s.width, s.height),
                k.clip());
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < p.length) {
                        ...
                        for (var da = !0; h < p.length; h++)
                            if (x = p[h].x.getTime ? p[h].x.getTime() : p[h].x,
                            !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !da)))
                                if ("number" !== typeof p[h].y)
                                    ...
                                    h < p.length - 1 && (T !== (p[h].lineColor || aa) || b !== (p[h].lineDashType || B.lineDashType)) && (c(),
                                    T = p[h].lineColor || aa,
                                    g.strokeStyle = T,
                                    g.setLineDash && (p[h].lineDashType ? (b = p[h].lineDashType,
                                    ...
                                    0 !== p[h].markerSize && (0 < p[h].markerSize || 0 < B.markerSize) && (x = B.getMarkerProperties(h, t, u, g),
                                    m.push(x),
                                    Z = N(Z),
                                    r && m.push({
                                        x: t,
            ...
            function d() {
                ...
                if (0 < b.length) {
                    ...
                    for (d = 0; d < b.length - 3; d += 3)
                        ...
                        r && e.bezierCurveTo(b[d + 1].x, b[d + 1].y, b[d + 2].x, b[d + 2].y, b[d + 3].x, b[d + 3].y);
                    a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? t = p : 0 > a.axisY.viewportMaximum ? t = k.y1 : 0 < a.axisY.viewportMinimum && (t = g.y2);
                    u = {
                        x: b[0].x,
                        y: b[0].y
                    };
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < n.length) {
                        ...
                        for (h = !1; f < n.length; f++)
                            ...
                            !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax && (!q.connectNullData || !h)))
                                if ("number" !== typeof n[f].y)
                                    0 < f && !h && (q.connectNullData ? c.setLineDash && (0 < x.length && (q.options.nullDataLineDashType || !n[f - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = aa,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < h.length) {
                        ...
                        for (; p < h.length; p++)
                            if (x = h[p].x.getTime ? h[p].x.getTime() : h[p].x,
                            !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !b))) {
                                var Z = u;
                                "number" !== typeof h[p].y ? (B.connectNullData || (b || d) || c(),
                                b = !0) : (t = a.axisX.convertValueToPixel(x),
                                u = a.axisY.convertValueToPixel(h[p].y),
                                ...
                                p < h.length - 1 && (T !== (h[p].lineColor || aa) || Y !== (h[p].lineDashType || B.lineDashType)) && (c(),
                                T = h[p].lineColor || aa,
                                g.strokeStyle = T,
                                g.setLineDash && (h[p].lineDashType ? (Y = h[p].lineDashType,
                                ...
                                0 !== h[p].markerSize && (0 < h[p].markerSize || 0 < B.markerSize) && (Z = B.getMarkerProperties(p, t, u, g),
                                m.push(Z),
                                x = N(x),
                                r && m.push({
                                    x: t,
                                ...
                                (h[p].indexLabel || B.indexLabel || h[p].indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "stepArea",
                                    dataPoint: h[p],
                                    dataSeries: B,
                                    point: {
                            ...
                            if (!(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !da)))
                                if ("number" !== typeof Z.y)
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        h = a.axisY.convertValueToPixel(Z.y),
                                        h -= oa;
                                    m.push({
                                        x: f,
                                        y: p - oa
                                    ...
                                    w[g] = p - h;
                                    C || da ? (!C && A.connectNullData ? (c.setLineDash && (A.options.nullDataLineDashType || x === A.lineDashType && A.lineDashType !== A.nullDataLineDashType) && (C = m.pop(),
                                    x = m[m.length - 1],
                                    d(),
                                    c.moveTo(t.x, t.y),
                                    m.push(x),
                                    ...
                                    0 <= A.dataPointIndexes[g] && 0 !== Z.markerSize && (0 < Z.markerSize || 0 < A.markerSize) && (oa = A.getMarkerProperties(A.dataPointIndexes[g], f, h, c),
                                    k.push(oa),
                                    g = N(la),
                                    r && k.push({
                                        x: f,
        ...
        p.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                c.clip();
                r && (x.beginPath(),
                x.rect(k.x1, k.y1, k.width, k.height),
                x.clip());
                for (var e = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var y = a.dataSeriesIndexes[v]
                      , A = this.data[y]
                            ...
                            if (!(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !da)))
                                if ("number" !== typeof Z.y)
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        h = a.axisY.convertValueToPixel(oa),
                                        h -= la;
                                    m.push({
                                        x: f,
                                        y: C - la
                                    ...
                                    w[g] = C - h;
                                    u || da ? (!u && A.connectNullData ? (c.setLineDash && (A.options.nullDataLineDashType || t === A.lineDashType && A.lineDashType !== A.nullDataLineDashType) && (u = m.pop(),
                                    t = m[m.length - 1],
                                    d(),
                                    c.moveTo(p.x, p.y),
                                    m.push(t),
                                    ...
                                    0 <= A.dataPointIndexes[g] && 0 !== Z.markerSize && (0 < Z.markerSize || 0 < A.markerSize) && (la = A.getMarkerProperties(n, f, h, c),
                                    l.push(la),
                                    g = N(G),
                                    r && l.push({
                                        x: f,
                    ...
                    if (0 < s.length) {
                        ...
                        for (var q = 0, n = 0, e = 0; e < s.length; e++)
                            ...
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[e].y) {
                                ...
                                b.globalAlpha = 1;
                                Math.sqrt((q - g) * (q - g) + (n - k) * (n - k)) < Math.min(f.size, 5) && s.length > Math.min(this.plotArea.width, this.plotArea.height) || (q = m.dataPointIds[e],
                                ...
                                (s[e].indexLabel || m.indexLabel || s[e].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "scatter",
                                    dataPoint: s[e],
                                    dataSeries: m,
                                    point: {
        ...
        p.prototype.renderCandlestick = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, g = null, k = this.plotArea, l = 0, w, m, s, q, n, f, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, g = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, h = a.axisX.dataInfo.minDiff;
                    ...
                    if (0 < C.length)
                        for (var x = 5 < h && t.bevelEnabled ? !0 : !1, l = 0; l < C.length; l++)
                            ...
                            !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !u(C[l].y) && C[l].y.length && "number" === typeof C[l].y[0] && "number" === typeof C[l].y[1] && "number" === typeof C[l].y[2] && "number" === typeof C[l].y[3]) {
                                ...
                                b.lineTo(w - D, Math.min(m, n)),
                                b.stroke(),
                                b.moveTo(w - D, Math.max(m, n)),
                                b.lineTo(w - D, q),
                                b.stroke(),
                                ea(b, z, Math.min(m, n), y, Math.max(m, n), C[l].y[0] <= C[l].y[3] ? t.risingColor : g, A, e, x, x, !1, !1, t.fillOpacity),
                                r && (e = N(aa),
                                c.strokeStyle = e,
                                c.moveTo(w - D, s),
                                c.lineTo(w - D, Math.min(m, n)),
                                c.stroke(),
                                c.moveTo(w - D, Math.max(m, n)),
                                c.lineTo(w - D, q),
                                c.stroke(),
                                ea(c, z, Math.min(m, n), y, Math.max(m, n), e, 0, null, !1, !1, !1, !1))) : "ohlc" === t.type && (b.moveTo(w - D, s),
                                b.lineTo(w - D, q),
                                b.stroke(),
                                b.beginPath(),
                                b.moveTo(w, m),
                ...
                for (var p = !1, p = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < x.length)
                        for (var z = 5 < h && C.bevelEnabled ? !0 : !1, k = 0; k < x.length; k++)
                            if (x[k].getTime ? f = x[k].x.getTime() : f = x[k].x,
                            !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !u(x[k].y) && x[k].y.length && "number" === typeof x[k].y[0] && "number" === typeof x[k].y[1] && "number" === typeof x[k].y[2] && "number" === typeof x[k].y[3] && "number" === typeof x[k].y[4] && 5 === x[k].y.length) {
                                ...
                                var y = l - h / 2 << 0
                                  ...
                                  , F = x[k].stemDashType ? x[k].stemDashType : C.stemDashType
                                ...
                                c.strokeStyle = e,
                                c.lineWidth = la,
                                0 < la && (c.moveTo(l - aa - G, m),
                                c.lineTo(l - aa - G, Math.max(w, q)),
                                c.stroke(),
                                c.moveTo(l - aa - G, Math.min(w, q)),
                                c.lineTo(l - aa - G, s),
                                c.stroke()),
                                ea(c, y, Math.max(m, s), A, Math.min(m, s), e, 0, null, !1, !1, !1, !1),
                                0 < Y && (c.beginPath(),
                                c.lineWidth = Y,
                                c.moveTo(l + da / 2, q - Z),
                                c.lineTo(l - da / 2, q - Z),
                                ...
                                c.lineTo(l - da / 2, w + Z),
                                c.stroke()));
                                (x[k].indexLabel || C.indexLabel || x[k].indexLabelFormatter || C.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: C.type,
                                    dataPoint: x[k],
                                    dataSeries: C,
                                    point: {
                    ...
                    if (0 < f.length)
                        for (var h = 5 < m && n.bevelEnabled ? !0 : !1, g = 0; g < f.length; g++)
                            ...
                            !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax) && !u(f[g].y) && f[g].y.length && "number" === typeof f[g].y[0] && "number" === typeof f[g].y[1]) {
                                ...
                                var p = a.axisX.reversed ? c + a.plotType.totalDataSeries * m / 2 - (a.previousDataSeriesCount + s) * m << 0 : c - a.plotType.totalDataSeries * m / 2 + (a.previousDataSeriesCount + s) * m << 0
        ...
        p.prototype.renderError = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                b.clip();
                r && (this._eventManager.ghostCtx.beginPath(),
                this._eventManager.ghostCtx.rect(k.x1, k.y1, k.width, k.height),
                this._eventManager.ghostCtx.clip());
                    ...
                    if (0 < y.length)
                        for (var aa = z._colorSet, l = 0; l < y.length; l++) {
                            ...
                            if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !u(y[l].y) && y[l].y.length && "number" === typeof y[l].y[0] && "number" === typeof y[l].y[1]) {
                                ...
                                c ? q = ca : f = ca;
                                c ? (n = a.axisX.reversed ? m + (A ? v : 1) * t / 2 - (A ? D - 1 : 0) * t << 0 : m - (A ? v : 1) * t / 2 + (A ? D - 1 : 0) * t << 0,
                ...
                for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                    ...
                    if (0 < h.length) {
                        ...
                        for (g = 0; g < h.length; g++)
                            if (h[g].getTime ? m = h[g].x.getTime() : m = h[g].x,
                            !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !u(h[g].y) && h[g].y.length && "number" === typeof h[g].y[0] && "number" === typeof h[g].y[1]) {
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < h.length) {
                        ...
                        for (f = !1; q < h.length; q++)
                            if (n = h[q].x.getTime ? h[q].x.getTime() : h[q].x,
                            !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !f)))
                                if (null !== h[q].y && h[q].y.length && "number" === typeof h[q].y[0] && "number" === typeof h[q].y[1]) {
                                    ...
                                    q < h.length - 1 && (x !== (h[q].lineColor || C) || F !== (h[q].lineDashType || m.lineDashType)) && (x = h[q].lineColor || C,
                                    u[u.length - 1].newStrokeStyle = x,
                                    c.setLineDash && (h[q].lineDashType ? (F = h[q].lineDashType,
                                    u[u.length - 1].newLineDashArray = R(F, m.lineThickness)) : (F = m.lineDashType,
                                    ...
                                    0 < q && !f && (m.connectNullData ? c.setLineDash && (0 < u.length && (m.options.nullDataLineDashType || !h[q - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = A,
                                    F = m.nullDataLineDashType) : (d(y, C),
                                    u = [],
                                    z = [])),
                                    f = !0;
                        d(y, C);
                ...
                for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
                    ...
                    if (0 < v.length)
                        for (var x = 5 < n && u.bevelEnabled ? !0 : !1, z = !1, y = null, A = null, k = 0; k < v.length; k++)
                            if (v[k].getTime ? s = v[k].x.getTime() : s = v[k].x,
                            "number" !== typeof v[k].y) {
                                ...
                                0 < k && y && (!z || u.connectNullData) && (z && b.setLineDash && b.setLineDash(R(D, t)),
                                b.beginPath(),
                                b.moveTo(y, A - C),
                                b.lineTo(T, Y - C),
                                0 < t && b.stroke(),
        ...
        p.prototype.renderPie = function(a) {
            function d() {
                if (m && s) {
                    for (var a = 0, b = 0, c = 0, e = 0, d = 0; d < s.length; d++) {
                        ...
                        k.indexLabelMaxWidth = g.indexLabelMaxWidth ? g.indexLabelMaxWidth : m.indexLabelMaxWidth ? m.indexLabelMaxWidth : 0.33 * n.width;
                        ...
                        if (k.midAngle > Math.PI / 2 - t && k.midAngle < Math.PI / 2 + t) {
                            if (0 === a || f[c].midAngle > k.midAngle)
                                c = d;
                            a++
                    ...
                    for (d = 0; d < s.length; d++)
                        k = f[(c + d) % s.length],
                        1 < a && (k.midAngle > Math.PI / 2 - t && k.midAngle < Math.PI / 2 + t) && (g <= a / 2 && !q ? (k.hemisphere = "right",
                        g++) : (k.hemisphere = "left",
                        q = !0));
                    q = !1;
                    for (d = 0; d < s.length; d++)
                        k = f[(e + d) % s.length],
                        1 < b && (k.midAngle > 3 * Math.PI / 2 - t && k.midAngle < 3 * Math.PI / 2 + t) && (l <= b / 2 && !q ? (k.hemisphere = "left",
                        l++) : (k.hemisphere = "right",
                        q = !0))
                }
            }
            function b(a) {
                ...
                for (b = b = 0; b < s.length; b++)
                    ...
                    e = 0,
                    e = "left" === c.hemisphere ? "inside" !== m.indexLabelPlacement ? -(c.indexLabelTextBlock.width + q) : -c.indexLabelTextBlock.width / 2 : "inside" !== m.indexLabelPlacement ? q : -c.indexLabelTextBlock.width / 2,
            ...
            function g(a, b, d) {
                ...
                if (0 <= a && a < s.length) {
                    ...
                    for (l = 1; l < s.length; l++)
                        if (m = (a - l + f.length) % f.length,
                        f[m].hemisphere !== f[a].hemisphere) {
                            m = null;
                            break
                        } else if (f[m].indexLabelText && f[m].hemisphere === f[a].hemisphere && m !== a && (0 > c(f[m], f[a]) || ("right" === f[a].hemisphere ? f[m].indexLabelTextBlock.y <= f[a].indexLabelTextBlock.y : f[m].indexLabelTextBlock.y >= f[a].indexLabelTextBlock.y)))
                            break;
                        else
                            m = null;
                    q = m;
                    h = e(a);
                    l = m = 0;
                    0 > b ? (l = "right" === n.hemisphere ? q : h,
                    k = b,
                    null !== l && (q = -b,
                    b = n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 - (f[l].indexLabelTextBlock.y + f[l].indexLabelTextBlock.height / 2),
                    b - q < p && (m = -q,
                    l = g(l, m, d + 1),
                    +l.toFixed(C) > +m.toFixed(C) && (k = b > p ? -(b - p) : -(q - (l - m)))))) : 0 < b && (l = "right" === n.hemisphere ? h : q,
                    k = b,
                    null !== l && (q = b,
                    b = f[l].indexLabelTextBlock.y - f[l].indexLabelTextBlock.height / 2 - (n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2),
                    b - q < p && (m = q,
                    l = g(l, m, d + 1),
                    +l.toFixed(C) < +m.toFixed(C) && (k = b > p ? b - p : q - (m - l)))));
                    k && (d = n.indexLabelTextBlock.y + k,
                    b = 0,
                    b = "right" === n.hemisphere ? x.x + Math.sqrt(Math.pow(r, 2) - Math.pow(d - x.y, 2)) : x.x - Math.sqrt(Math.pow(r, 2) - Math.pow(d - x.y, 2)),
                    n.midAngle > Math.PI / 2 - t && n.midAngle < Math.PI / 2 + t ? (m = (a - 1 + f.length) % f.length,
                    m = f[m],
                    a = f[(a + 1 + f.length) % f.length],
                    "left" === n.hemisphere && "right" === m.hemisphere && b > m.indexLabelTextBlock.x ? b = m.indexLabelTextBlock.x - 15 : "right" === n.hemisphere && ("left" === a.hemisphere && b < a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x + 15)) : n.midAngle > 3 * Math.PI / 2 - t && n.midAngle < 3 * Math.PI / 2 + t && (m = (a - 1 + f.length) % f.length,
                    m = f[m],
                    a = f[(a + 1 + f.length) % f.length],
                    "right" === n.hemisphere && "left" === m.hemisphere && b < m.indexLabelTextBlock.x ? b = m.indexLabelTextBlock.x + 15 : "left" === n.hemisphere && ("right" === a.hemisphere && b > a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x - 15)),
                ...
                for (var b = a = 0, d = 0, k = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
                    ...
                    for (a = 0; a < s.length; a++)
                        ...
                        0 !== y.height && 0 !== y.width)
                            ...
                            0 < y && (!k && l.indexLabelText && (u = "right" === l.hemisphere ? n.x2 - l.indexLabelTextBlock.x : l.indexLabelTextBlock.x - n.x1,
                            ...
                            0 < y && (!k && l.indexLabelText && (u = 0 < l.indexLabelAngle && l.indexLabelAngle < Math.PI ? -1 : 1,
                            0 === g(a, y * u) && g(a, 2 * u)),
                            ...
                            t.indexLabelText) {
                                ...
                                if (null !== k) {
                                    ...
                                    if (n = 0 > z) {
                                        ...
                                        var h = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height / 2
            ...
            function l() {
                ...
                h.legend && (h.legend.dockInsidePlotArea || "center" === h.legend.horizontalAlign && "center" === h.legend.verticalAlign) && (h.legend.setLayout(),
                h.legend.render())
            }
            var h = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var m = this.data[a.dataSeriesIndexes[0]], s = m.dataPoints, q = 10, n = this.plotArea, f = m.dataPointEOs, p = 2, r, v = 1.3, t = 20 / 180 * Math.PI, C = 6, x = {
                    x: (n.x2 + n.x1) / 2,
                    y: (n.y2 + n.y1) / 2
                }, z = 0;
                a = !1;
                ...
                if (0 !== z) {
                    ...
                    this.pieDoughnutClickHandler = function(a) {
                        h.isAnimating || !u(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint,
                        a.exploded = a.exploded ? !1 : !0,
                        1 < this.dataPoints.length && h._animator.animate(0, 500, function(a) {
                            b(a);
                            l()
                        }))
                    }
        ...
        p.prototype.renderFunnel = function(a) {
            ...
            function b() {
                ...
                for (var m = e[0] = 0, k = 0, n, h, b = b - a, m = !1, l = 0; l < C.length; l++)
                    ...
                    m ? n = 0 == Number(c.toFixed(3)) ? 0 : a / c : (h = ba * ba * b * b - 4 * Math.abs(ba) * a,
                    0 > h ? (h = c,
                    m = (b + h) * (d - k) / 2,
                    a -= m,
                    n = d - k,
                    ...
                    n += 0 == h ? 0 : a / h,
                    k += a / h,
                    m = !0) : (n = (Math.abs(ba) * b - Math.sqrt(h)) / 2,
                    h = b - 2 * n / Math.abs(ba),
                    k += n,
                    k > d && (k -= n,
                    h = c,
            ...
            function e() {
                ...
                if (d)
                    for (k = J.length - 1; 0 <= k; k--)
                        a = P[k],
                        J[k].textBlock.maxWidth = f[f.length - (k + 1)],
                        J[k].textBlock.measureText(),
                        J[k].textBlock.x = L - l,
                        c = J[k].textBlock.height < J[k].textBlock.maxHeight ? J[k].textBlock.height : J[k].textBlock.maxHeight,
                        d = J[k].textBlock.width < J[k].textBlock.maxWidth ? J[k].textBlock.width : J[k].textBlock.maxWidth,
                        J[k].height = c,
                        J[k].width = d,
                        c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2,
                        J[k].textBlock.y = c - J[k].height / 2,
                        t.reversed ? (J[k].textBlock.y + J[k].height > pa + D && (J[k].textBlock.y = pa + D - J[k].height),
                        J[k].textBlock.y < wa - D && (J[k].textBlock.y = wa - D)) : (J[k].textBlock.y < pa - D && (J[k].textBlock.y = pa - D),
                        J[k].textBlock.y + J[k].height > wa + D && (J[k].textBlock.y = wa + D - J[k].height))
            }
            function g() {
                var a, b, c, e;
            ...
            function k() {
                ...
                for (var d, e, f, g, k, m, h = 1, s = 0; s < 2 * h; s++) {
                    ...
                    f = J[w],
                    g = f.textBlock,
                    m = (k = n(w) < P.length ? J[n(w)] : null) ? k.textBlock : null,
                    d = +f.height.toFixed(6),
                    e = +g.y.toFixed(6),
                    !f.isDirty && (k && e + d + ga > +m.y.toFixed(6)) && (d = g.y + d + ga - m.y,
                    e = a(w, -d),
                    e < d && (0 < e && (d -= e),
                    e = a(n(w), d),
                    e != d))); w--)
        ...
        p.prototype.replaceKeywordsWithValue = function(a, d, b, c, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                try {
                    var f = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    f && 0 < f.length && (k = Ia(f[2]),
                    a = Ia(f[1]))
                } catch (l) {}
                f = null;
                if ("color" === a)
                    return "waterfall" === b.type ? d.color ? d.color : 0 < d.y ? b.risingColor : b.fallingColor : "error" === b.type ? b.color ? b.color : b._colorSet[k % b._colorSet.length] : d.color ? d.color : b.color ? b.color : b._colorSet[c % b._colorSet.length];
        ...
        H.prototype.setLayout = function() {
            ...
            k = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height) : "center" === this.verticalAlign && (this.orientation = "vertical",
            b = this.horizontalAlign,
            g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : 0.5 * d.width,
            k = this.maxHeight = null !== this.maxHeight ? this.maxHeight : d.height);
                ...
                if (q.dataPoints && q.dataPoints.length)
                    if ("pie" !== q.type && "doughnut" !== q.type && "funnel" !== q.type && "pyramid" !== q.type) {
                        ...
                        for (var z = 0; z < q.dataPoints.length; z++) {
                            ...
                            (x.showInLegend || q.showInLegend && !1 !== x.showInLegend) && h.push(n)
                        }
            }
            ...
            if (0 < h.length) {
                ...
                for (s = 0; s < h.length; s++) {
                    ...
                    if (!(0 >= k || "undefined" === typeof k || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            n.textBlock.measureText(),
                            null !== this.itemWidth && (n.textBlock.width = this.itemWidth - (r + l + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                            this.height < k - this.lineHeight ? (q = {
                                items: [],
                                width: 0
                            },
                            m.push(q)) : (q = m[z],
        ...
        z.prototype.createLabels = function() {
            ...
            if ("bottom" === this._position || "top" === this._position)
                ...
                this.chart.panEnabled || (k = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize);
                ...
                k = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                        ...
                        for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
                            if (!this._labels[b].breaksLabelType) {
                                ...
                                if (u(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? k : Math.min((c - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), c),
                                    p = (m - (h + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)),
                                    ...
                                    (this.sessionVariables.labelAngle = this.labelAngle,
                                    this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? k : Math.min((c - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), c),
                                    p = 0 != this.labelAngle ? (m - (h + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) : g,
                                    this.sessionVariables.labelMaxHeight = k = this.labelWrap ? (m - p * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) : 1.5 * this.labelFontSize,
                                    ...
                                    this.sessionVariables.labelMaxHeight = k) : (this.sessionVariables.labelAngle = this.labelAngle,
                                    this.sessionVariables.labelMaxWidth = p,
                    ...
                    !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (b = 0; b < this._labels.length; b++)
                            if (!this._labels[b].breaksLabelType) {
                                ...
                                l - 2 * k > n && (n = l - 2 * k,
                                l >= 2 * k && l < 2.4 * k ? (u(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelMaxHeight = k,
                                this.sessionVariables.labelFontSize = u(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : l >= 2.4 * k && l < 2.8 * k ? (this.sessionVariables.labelMaxHeight = c,
                                this.sessionVariables.labelFontSize = this.labelFontSize,
                                this.sessionVariables.labelWrap = !0) : l >= 2.8 * k && l < 3.2 * k ? (this.sessionVariables.labelMaxHeight = k,
                                this.sessionVariables.labelWrap = !0,
                                u(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = u(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelAngle = u(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : l >= 3.2 * k && l < 3.6 * k ? (this.sessionVariables.labelMaxHeight = c,
                                this.sessionVariables.labelWrap = !0,
                                this.sessionVariables.labelFontSize = this.labelFontSize) : l > 3.6 * k && l < 10 * k ? (u(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = u(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelMaxWidth = g,
                                this.sessionVariables.labelMaxHeight = k,
                                this.sessionVariables.labelAngle = u(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : l > 10 * k && l < 50 * k && (u(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = u(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelMaxHeight = k,
                                this.sessionVariables.labelMaxWidth = g,
                                this.sessionVariables.labelAngle = u(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = k,
                                this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth)) : (this.sessionVariables.labelMaxWidth = this.labelWrap ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : this.labelMaxWidth ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : g,
                                this.sessionVariables.labelMaxHeight = k) : (this.sessionVariables.labelAngle = this.labelAngle,
                                this.sessionVariables.labelMaxWidth = 0 === this.labelAngle ? g : Math.min((c - k * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), k),
                                ...
                                this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? k : c,
                                u(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? k : c,
                                this.sessionVariables.labelWrap = this.labelWrap,
                                this.sessionVariables.labelMaxWidth = g) : (this.sessionVariables.labelMaxHeight = k,
            ...
            for (b = 0; b < this.stripLines.length; b++) {
                ...
                if ("outside" === g.labelPlacement) {
                    ...
                    k = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0,
        ...
        z.setLayout = function(a, d, b, c, e, g) {
            ...
            if ("normal" === e) {
                for (var C = [], x = [], D = [], y = [], M = [], N = [], O = [], Q = []; 4 > v; ) {
                    ...
                    h = Math.round(g.x2 - ba - $ > p.width - q ? p.width - q : g.x2 - ba - $);
                    if (a && 0 < a.length)
                        for (C = [],
                        f = V = 0; f < a.length; f++)
                            a[f] && (a[f].lineCoordinates = {}),
                            a[f].lineCoordinates.width = Math.abs(h - k),
                    ...
                    if (d && 0 < d.length)
                        ...
                        f = X = 0; f < d.length; f++)
                            ...
                            d[f].lineCoordinates.width = Math.abs(h - k),
                    ...
                    if (a && 0 < a.length)
                        for (f = 0; f < a.length; f++)
                            a[f] && (a[f].lineCoordinates.x1 = k,
                            h = Math.round(g.x2 - ba - $ > p.width - q ? p.width - q : g.x2 - ba - $),
                            a[f]._labels && 1 < a[f]._labels.length && (l = m = 0,
                            m = a[f]._labels[1],
                            l = "dateTime" === a[f].valueType ? a[f]._labels[a[f]._labels.length - 2] : a[f]._labels[a[f]._labels.length - 1],
                            z = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)),
                            ...
                            0 < a[f].labelAngle ? E + t > h && (l += 0 < a[f].labelAngle ? E + t - h - ba : 0) : 0 > a[f].labelAngle ? A - z < k && A - z < a[f].viewportMinimum && (F = k - (K + a[f].tickLength + D + A - z + a[f].labelFontSize / 2)) : 0 === a[f].labelAngle && (E + t > h && (l = E + t / 2 - h - ba),
                            A - z < k && A - z < a[f].viewportMinimum && (F = k - K - a[f].tickLength - D - A + z / 2)),
                            a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 < a[f].labelAngle && 0 < l ? h -= l : a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 > a[f].labelAngle && 0 < F ? k += F : a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 === a[f].labelAngle && (0 < F && (k += F),
                            0 < l && (h -= l))),
                            p.panEnabled ? V = p.sessionVariables.axisX.height : p.sessionVariables.axisX.height = V,
                            l = Math.round(g.y2 - V - e + G),
                            m = Math.round(g.y2),
                            a[f].lineCoordinates.x2 = h,
                            a[f].lineCoordinates.width = h - k,
                    ...
                    if (d && 0 < d.length)
                        for (f = 0; f < d.length; f++)
                            ...
                            d[f].lineCoordinates.width = Math.abs(h - k),
                            d[f]._labels && 1 < d[f]._labels.length && (m = d[f]._labels[1],
                    ...
                    if (b && 0 < b.length)
                        for (f = 0; f < b.length; f++)
                            ...
                            b[f] && (k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1),
                    ...
                    if (c && 0 < c.length)
                        for (f = 0; f < c.length; f++)
                            c[f] && (k = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2),
                            h = Math.round(k),
                    ...
                    if (a && 0 < a.length)
                        for (f = 0; f < a.length; f++)
                            ...
                            k = a[f]._labels[a[f]._labels.length - ("dateTime" === a[f].valueType ? 2 : 1)].position,
                            k = a[f].getApparentDifference(a[f].viewportMinimum, k),
                            E = a[f].logarithmic ? (1 < k ? Math.log(k) / a[f].conversionParameters.lnLogarithmBase * Math.abs(a[f].conversionParameters.pixelPerUnit) : 0) + a[f].lineCoordinates.x1 : (0 < k ? k * Math.abs(a[f].conversionParameters.pixelPerUnit) : 0) + a[f].lineCoordinates.x1));
                    if (d && 0 < d.length)
                        for (f = 0; f < d.length; f++)
                            ...
                            k = d[f]._labels[d[f]._labels.length - ("dateTime" === d[f].valueType ? 2 : 1)].position,
                            k = d[f].getApparentDifference(d[f].viewportMinimum, k),
                            E = d[f].logarithmic ? (1 < k ? Math.log(k) / d[f].conversionParameters.lnLogarithmBase * Math.abs(d[f].conversionParameters.pixelPerUnit) : 0) + d[f].lineCoordinates.x1 : (0 < k ? k * Math.abs(d[f].conversionParameters.pixelPerUnit) : 0) + d[f].lineCoordinates.x1);
                    for (f = 0; f < n.length; f++)
                ...
                for (N = []; 4 > v; ) {
                    ...
                    if (b && 0 < b.length)
                        for (f = 0; f < b.length; f++)
                            ...
                            h = Math.round(g.x2 - V - W > p.width - 10 ? p.width - 10 : g.x2 - V - W),
                            b[f].labelAutoFit && !u(C) && (0 < !a.length && (k = 0 > b[f].labelAngle ? Math.max(k, C) : 0 === b[f].labelAngle ? Math.max(k, C / 2) : k),
                            0 < !d.length && (h = 0 < b[f].labelAngle ? h - x / 2 : 0 === b[f].labelAngle ? h - x / 2 : h)),
                            b[f].lineCoordinates.x1 = k,
                            b[f].lineCoordinates.x2 = h,
                            b[f].lineCoordinates.width = Math.abs(h - k),
                    ...
                    if (c && 0 < c.length)
                        for (f = 0; f < c.length; f++)
                            c[f].lineCoordinates = {},
                            k = Math.round(g.x1 + U + e),
                            h = Math.round(g.x2 - V - W > c[f].chart.width - 10 ? c[f].chart.width - 10 : g.x2 - V - W),
                            c[f] && c[f].labelAutoFit && !u(D) && (0 < !a.length && (k = 0 < c[f].labelAngle ? Math.max(k, D) : 0 === c[f].labelAngle ? Math.max(k, D / 2) : k),
                            0 < !d.length && (h -= y / 2)),
                            c[f].lineCoordinates.x1 = k,
                            c[f].lineCoordinates.x2 = h,
                            c[f].lineCoordinates.width = Math.abs(h - k),
                    ...
                    if (b && 0 < b.length)
                        for (f = 0; f < b.length; f++)
                            0 < b[f]._labels.length && (m = b[f]._labels[0],
                            l = b[f]._labels[b[f]._labels.length - 1],
                            C = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)),
                    ...
                    if (c && 0 < c.length)
                        for (f = 0; f < c.length; f++)
                            c[f] && 0 < c[f]._labels.length && (m = c[f]._labels[0],
                            l = c[f]._labels[c[f]._labels.length - 1],
                            D = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)),
                    ...
                    if (c && 0 < c.length)
                        for (f = c.length - 1; 0 <= f; f--)
                            ...
                            m = Math.round(g.y1 + (A[f] + c[f].margin + G)),
                        ...
                        for (f = 0; f < a.length; f++) {
                            ...
                            if (b && 0 < b.length)
                                for (K = 0; K < b.length; K++)
                                    b[K] && b[K].labelAutoFit && (h = 0 > b[K].labelAngle ? Math.max(h, C) : 0 === b[K].labelAngle ? Math.max(h, C / 2) : h,
                                    k = 0 > b[K].labelAngle || 0 === b[K].labelAngle ? h - U : k);
                            if (c && 0 < c.length)
                                for (K = 0; K < c.length; K++)
                                    c[K] && c[K].labelAutoFit && (h = c[K].lineCoordinates.x1,
                                    k = h - U);
                            a[f].lineCoordinates = {
                                x1: h - O,
                                y1: l,
                    ...
                    if (d && 0 < d.length)
                        for (f = 0; f < d.length; f++) {
                            ...
                            if (b && 0 < b.length)
                                for (K = 0; K < b.length; K++)
                                    b[K] && b[K].labelAutoFit && (h = 0 > b[K].labelAngle ? Math.max(h, C) : 0 === b[K].labelAngle ? Math.max(h, C / 2) : h,
                                    k = 0 > b[K].labelAngle || 0 === b[K].labelAngle ? h - V : k);
                            if (c && 0 < c.length)
                                for (K = 0; K < c.length; K++)
                                    c[K] && c[K].labelAutoFit && (h = c[K].lineCoordinates.x2,
                                    k = h - V);
                            d[f].lineCoordinates = {
                                x1: h + Q,
                                y1: l,
                    ...
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var b = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, k, l = this.viewportMaximum, h = this.lineCoordinates.width / Math.log(this.range), m = this._labels.length - 1; 0 <= m; m--) {
                            ...
                            if (q.position < this.viewportMinimum)
                                break;
                            q.position > this.viewportMaximum || !(m === this._labels.length - 1 || k < Math.log(l / q.position) * h / e) || (b.push(q),
                            l = q.position,
                            k = q.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = b
                    } else {
                        for (m = 0; m < this._labels.length; m++)
                            q = this._labels[m],
                            q.position < this.viewportMinimum || (k = q.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                            b += k);
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var b = [], p, l = this.viewportMaximum, h = this.lineCoordinates.height / Math.log(this.range), m = this._labels.length - 1; 0 <= m; m--) {
                            ...
                            if (q.position < this.viewportMinimum)
                                break;
                            q.position > this.viewportMaximum || !(m === this._labels.length - 1 || p < Math.log(l / q.position) * h) || (b.push(q),
                            l = q.position,
                ...
                for (c = 0; c < this._stripLineLabels.length; c++)
                    ...
                    !(b.position < this.viewportMinimum || b.position > this.viewportMaximum || isNaN(this.range))) {
                        ...
                        if ("outside" === b.stripLine.labelPlacement)
                            if (m && (this.ctx.strokeStyle = m.color,
                            ...
                            a.x - b.textBlock.height > this.chart.plotArea.x1 ? u(m.startValue) ? a.x -= b.textBlock.height - b.textBlock.fontSize / 2 : a.x -= b.textBlock.height / 2 - b.textBlock.fontSize / 2 + 3 : (b.textBlock.angle = 90,
                            u(m.startValue) ? a.x += b.textBlock.height - b.textBlock.fontSize / 2 : a.x += b.textBlock.height / 2 - b.textBlock.fontSize / 2 + 3),
                    ...
                    if (this.scaleBreaks && !u(this.scaleBreaks.firstBreakIndex))
                        if (u(this.scaleBreaks.lastBreakIndex))
                            ...
                            for (var l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++)
                                d.moveTo(e, k),
                                d.lineTo(this.scaleBreaks._appliedBreaks[l].startPixel + b, k),
                ...
                if (this.scaleBreaks && !u(this.scaleBreaks.firstBreakIndex))
                    if (u(this.scaleBreaks.lastBreakIndex))
                        ...
                        for (l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++)
                            d.moveTo(k, e),
                            d.lineTo(k, this.scaleBreaks._appliedBreaks[l].startPixel + c),
        ...
        z.prototype.calculateAxisParameters = function() {
            if (this.logarithmic)
                ...
                if ("axisX" === this.type) {
                    ...
                    g += c,
                    e -= c);
                    Infinity !== this.dataInfo.minDiff ? k = this.dataInfo.minDiff : 1 < g - e ? k = 0.5 * Math.abs(g - e) : (k = 1,
                    b && (d = !0))
                } else
                    ...
                    0 !== g && (g += c),
                    0 !== e && (e -= c)),
                    k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - e ? 0.5 * Math.abs(g - e) : 1,
                ...
                if (null === this.minimum || null === this.maximum)
                    ...
                    g += c,
                    e -= c),
                    k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - e ? 0.5 * Math.abs(g - e) : 1) : "axisY" === this.type && (e = null !== this.minimum ? this.minimum : this.dataInfo.min,
                    g = null !== this.maximum ? this.maximum : this.dataInfo.max,
                    ...
                    "axisX" === this.type && b) {
                        ...
                        null === this.minimum && (this.minimum = "axisX" === this.type ? e - k / 2 : Math.floor(e / this.interval) * this.interval,
                        ...
                        null === this.maximum && (this.maximum = "axisX" === this.type ? g + k / 2 : Math.ceil(g / this.interval) * this.interval,
        ...
        z.prototype.calculateLogarithmicAxisParameters = function() {
            ...
            1 === e / c && (k = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval),
            e *= k,
            c /= k),
            ...
            c = 1) : 1 === e / c ? (k = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)),
            e *= k,
            c /= k) : c > e ? (k = Math.min(c / e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)),
            1 <= e ? c = e / k : e = c * k) : (k = Math.min(e / c * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04)),
            1 !== e && (e *= k),
            1 !== c && (c /= k)),
            ...
            this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = z.getNiceExponent(Math.log(k) / d / (a - 1), !0),
            ...
            this.options && "undefined" === typeof this.options.interval && (this.interval = z.getNiceExponent(Math.ceil(Math.log(k) / d) / (a - 1)),
            ...
            if (null === this.minimum || null === this.maximum)
                ...
                c /= this.logarithmBase) : 1 === e / c ? (k = Math.pow(this.logarithmBase, this.interval),
                e *= k,
                c /= k) : c > e ? (k = Math.min(0.01 * (c / e), 5),
                1 <= e ? c = e / k : e = c * k) : (k = Math.min(e / c * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04)),
                1 !== e && (e *= k),
                1 !== c && (c /= k)) : (e = "undefined" === typeof this.options.interval ? 0 : this.options.interval,
                c = 1),
                g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / c > this.logarithmBase ? e / c * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase,
        ...
        L.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    ...
                    k = this.chart.plotArea.x2 + q / 2 + 0.5 << 0) : (c = this.chart.plotArea.x2,
        ...
        X.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    ...
                    k = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0,
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("rangeBar" === k[0].dataSeries.type || "error" === k[0].dataSeries.type)
                        for (var f = Math.abs(a - this.parent.convertValueToPixel(k[r].dataPoint.y[0])), v = 0, n = 0; n < k.length; n++)
                            if (k[n].dataPoint.y && k[n].dataPoint.y.length)
                                ...
                                v = Math.abs(a - this.parent.convertValueToPixel(k[n].dataPoint.y)),
                                v < f && (f = v,
                                r = n);
                        ...
                        for (var f = Math.abs(a - this.parent.convertValueToPixel(k[0].dataPoint.y)), t = D = v = 0, n = 0; n < k.length; n++)
                            if (k[n].dataPoint.y && k[n].dataPoint.y.length)
                                ...
                                D += k[n].dataPoint.y,
                                t = k[n].dataPoint.x.getTime ? k[n].dataPoint.x.getTime() : k[n].dataPoint.x,
                                t = 100 * (D / k[n].dataSeries.plotUnit.dataPointYSums[t]),
                                v = Math.abs(a - this.parent.convertValueToPixel(t)),
                                v < f && (f = v,
                                r = n);
                    else
                        for (f = Math.abs(a - this.parent.convertValueToPixel(k[0].dataPoint.y)),
                        n = r = v = 0; n < k.length; n++)
                            if (k[n].dataPoint.y && k[n].dataPoint.y.length)
                                for (h = 0; h < k[n].dataPoint.y.length; h++)
                                    v = Math.abs(a - this.parent.convertValueToPixel(k[n].dataPoint.y[h])),
                                    v < f && (f = v,
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[r].type || "error" === this.parent.dataSeries[r].type) {
                            ...
                            for (n = v = 0; n < h.dataPoint.y.length; n++)
                                v = Math.abs(a - this.parent.convertValueToPixel(h.dataPoint.y[n])),
                                v < f && (f = v,
                                b = n);
                            ...
                            k = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(h.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(h.dataPoint.y) << 0,
                            l.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                        ...
                        if (this.parent.labels)
                            for (k = Math.ceil(this.parent.interval),
                            n = 0; n < this.parent.viewportMaximum; n += k)
                    ...
                    if ("rangeColumn" === k[0].dataSeries.type || "rangeArea" === k[0].dataSeries.type || "error" === k[0].dataSeries.type || "rangeSplineArea" === k[0].dataSeries.type || "candlestick" === k[0].dataSeries.type || "ohlc" === k[0].dataSeries.type || "boxAndWhisker" === k[0].dataSeries.type)
                        for (f = Math.abs(d - this.parent.convertValueToPixel(k[0].dataPoint.y[0])),
                        n = v = 0; n < k.length; n++)
                            if (k[n].dataPoint.y && k[n].dataPoint.y.length)
                                for (h = 0; h < k[n].dataPoint.y.length; h++)
                                ...
                                v = Math.abs(d - this.parent.convertValueToPixel(k[n].dataPoint.y)),
                                v < f && (f = v,
                                r = n);
                    else if ("stackedColumn" === k[0].dataSeries.type || "stackedArea" === k[0].dataSeries.type)
                        for (f = Math.abs(d - this.parent.convertValueToPixel(k[0].dataPoint.y)),
                        n = D = v = 0; n < k.length; n++)
                            if (k[n].dataPoint.y && k[n].dataPoint.y.length)
                                for (h = 0; h < k[n].dataPoint.y.length; h++)
                                    v = Math.abs(d - this.parent.convertValueToPixel(k[n].dataPoint.y[h])),
                                    v < f && (f = v,
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[r].type || "rangeArea" === this.parent.dataSeries[r].type || "error" === this.parent.dataSeries[r].type || "rangeSplineArea" === this.parent.dataSeries[r].type || "candlestick" === this.parent.dataSeries[r].type || "ohlc" === this.parent.dataSeries[r].type || "boxAndWhisker" === this.parent.dataSeries[r].type) {
                        ...
                        "waterfall" === this.parent.dataSeries[r].type ? (k = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(h.dataSeries.dataPointEOs[h.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(h.dataSeries.dataPointEOs[h.index].cumulativeSum) << 0,
                        l.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: h.dataSeries.dataPointEOs[h.index].cumulativeSum
                        }) : u(this.options.label) ? ba(h.dataSeries.dataPointEOs[h.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label) : (k = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(h.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(h.dataPoint.y) << 0,
                        l.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                ...
                k = null;
                ("bottom" === this.parent._position || "top" === this.parent._position) && (b >= this.parent.convertValueToPixel(this.parent.viewportMinimum) && c <= this.parent.convertValueToPixel(this.parent.viewportMaximum)) && (0 < m && (p.moveTo(b, e),
                p.lineTo(c, g),
                p.stroke()),
                p.restore(),
                !u(l.text) && ("number" === typeof l.text.valueOf() || 0 < l.text.length) && l.render(!0));
                ("left" === this.parent._position || "right" === this.parent._position) && (g >= this.parent.convertValueToPixel(this.parent.viewportMaximum) && e <= this.parent.convertValueToPixel(this.parent.viewportMinimum)) && (0 < m && (p.moveTo(b, e),
                p.lineTo(c, g),
                p.stroke()),
                p.restore(),
                !u(l.text) && ("number" === typeof l.text.valueOf() || 0 < l.text.length) && l.render(!0))
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    b = c = k = 1 === p.lineWidth % 2 ? (a << 0) + 0.5 : a << 0,
                    e = this.chart.plotArea.y1,
                    g = this.chart.plotArea.y2,
                    this.bounds = {
                        x1: b - m / 2,
                    ...
                    e = g = k = 1 === p.lineWidth % 2 ? (d << 0) + 0.5 : d << 0,
                    b = this.chart.plotArea.x1,
                    c = this.chart.plotArea.x2,
                    this.bounds = {
                        x1: b,
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var h = 0; h < this.chart.axisX.length; h++) {
                                for (var k = this.chart.axisX[h].convertPixelToValue({
                                    y: d
                                }), m = null, c = 0; c < this.chart.axisX[h].dataSeries.length; c++)
                        ...
                        if (this.chart.axisX2)
                            for (h = 0; h < this.chart.axisX2.length; h++) {
                                ...
                                m = null;
                                for (c = 0; c < this.chart.axisX2[h].dataSeries.length; c++)
                                    (m = this.chart.axisX2[h].dataSeries[c].getDataPointAtX(k, b)) && 0 <= m.index && (m.dataSeries = this.chart.axisX2[h].dataSeries[c],
                                    null !== m.dataPoint.y && l.push(m));
                                m = null
                            }
                    } else {
                        ...
                        if (this.chart.axisX)
                            for (h = 0; h < this.chart.axisX.length; h++)
                                ...
                                m = null,
                                c = 0; c < this.chart.axisX[h].dataSeries.length; c++)
                                    (m = this.chart.axisX[h].dataSeries[c].getDataPointAtX(k, b)) && 0 <= m.index && (m.dataSeries = this.chart.axisX[h].dataSeries[c],
                                    null !== m.dataPoint.y && l.push(m));
                        if (this.chart.axisX2)
                            for (h = 0; h < this.chart.axisX2.length; h++)
                                ...
                                m = null,
                                c = 0; c < this.chart.axisX2[h].dataSeries.length; c++)
                                    (m = this.chart.axisX2[h].dataSeries[c].getDataPointAtX(k, b)) && 0 <= m.index && (m.dataSeries = this.chart.axisX2[h].dataSeries[c],
                                    null !== m.dataPoint.y && l.push(m))
                    }
                    if (0 === l.length)
                    ...
                    if (m = this.chart.getDataPointAtXY(a, d, b))
                        ...
                        if (m = ab(a, d, this.chart._eventManager.ghostCtx),
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        if (0 <= this.currentDataPointIndex)
                            ...
                            m.distance = Math.abs(c.x - k),
                            "waterfall" === e.type && (m.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue,
                        ...
                        if (!u(m) && !u(m.dataPoint) && !u(m.dataPoint.y))
                            if (m.dataSeries.axisY)
                                if (0 < m.dataPoint.y.length) {
                                    ...
                                    "column" === e.type || "bar" === e.type ? 0 > m.dataPoint.y ? 0 > m.dataSeries.axisY.viewportMinimum && m.dataSeries.axisY.viewportMaximum >= m.dataPoint.y && g.push(m) : m.dataSeries.axisY.viewportMinimum <= m.dataPoint.y && 0 <= m.dataSeries.axisY.viewportMaximum && g.push(m) : "bubble" === e.type ? (b = this.chart._eventManager.objectMap[e.dataPointIds[m.index]].size / 2,
                                    m.dataPoint.y >= m.dataSeries.axisY.viewportMinimum - b && m.dataPoint.y <= m.dataSeries.axisY.viewportMaximum + b && g.push(m)) : "waterfall" === e.type ? (b = 0,
                                    m.cumulativeSumYStartValue < m.dataSeries.axisY.viewportMinimum ? b-- : m.cumulativeSumYStartValue > m.dataSeries.axisY.viewportMaximum && b++,
                                    m.cumulativeSum < m.dataSeries.axisY.viewportMinimum ? b-- : m.cumulativeSum > m.dataSeries.axisY.viewportMaximum && b++,
                                    2 > b && -2 < b && g.push(m)) : (0 <= m.dataSeries.type.indexOf("100") || "stackedColumn" === e.type || "stackedBar" === e.type || m.dataPoint.y >= m.dataSeries.axisY.viewportMinimum && m.dataPoint.y <= m.dataSeries.axisY.viewportMaximum) && g.push(m);
                            else
                                g.push(m)
                    }
                }
                if (0 < g.length) {
                    if (this.highlightObjects(g),
                    this.enabled)
                        if (b = "",
        ...
        $.prototype.getToolTipInnerHTML = function(a) {
            ...
            if (k && (this.content && "function" === typeof this.content || this.contentFormatter))
                ...
                for (var p = null, m = "", h = 0; h < a.length; h++)
                    ...
                    e = a[h].index,
                    g = "",
                    0 === h && (k && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? m += "undefined" !== typeof this.chart.axisX[0].labels[c.x] ? this.chart.axisX[0].labels[c.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length && (m += "undefined" !== typeof this.chart.axisX2[0].labels[c.x] ? this.chart.axisX2[0].labels[c.x] : "{x}"),
                    m += "</br>",
                    ...
                    h < a.length - 1 && (d = "</br>" + d)) : (d += this.chart.replaceKeywordsWithValue(g, c, b, e),
                    h < a.length - 1 && (d += "</br>")));
                null !== d && (d = m + d)
            } else {
                b = a[0].dataSeries;
